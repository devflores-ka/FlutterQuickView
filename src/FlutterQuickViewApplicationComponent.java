...
/**
 * Componente a nivel de aplicación para FlutterQuickView
 * Se inicializa una vez cuando se carga el IDE y se mantiene durante toda la sesión
 */
public class FlutterQuickViewApplicationComponent implements ApplicationComponent {
    private static final Logger LOG = Logger.getInstance(FlutterQuickViewApplicationComponent.class);
    private static final String COMPONENT_NAME = "FlutterQuickView.ApplicationComponent";

    @Override
    public void initComponent() {
        LOG.info("Inicializando FlutterQuickView Application Component");
        ...
        LOG.info("FlutterQuickView Application Component inicializado correctamente");
    }

    @Override
    public void disposeComponent() {
        LOG.info("Finalizando FlutterQuickView Application Component");

        // Limpiar recursos globales
        cleanupGlobalResources();

        LOG.info("FlutterQuickView Application Component finalizado");
    }
    ...
    /**
     * Obtiene la instancia del componente de aplicación
     */
    public static FlutterQuickViewApplicationComponent getInstance() {
        return ApplicationManager.getApplication().getComponent(FlutterQuickViewApplicationComponent.class);
    }
